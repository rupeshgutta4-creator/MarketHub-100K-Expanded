...
const FIELD_NAMES = ['id', 'name', 'slug', 'description', 'imageUrl', 'rules', 'status', 'position', 'createdAt', 'updatedAt'];
...
const PARAMETER_DEFINITIONS = Object.freeze({
  ...
  'slug': Object.freeze({'type': 'string', 'required': true, 'nullable': false}),
