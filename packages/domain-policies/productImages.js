'use strict';
// Policy engine for productImages.
const DOMAIN = 'productImages';
const FIELDS = ['id', 'productId', 'variantId', 'url', 'altText', 'position', 'width', 'height', 'mimeType', 'isPrimary', 'createdAt'];
...
function requiredRule_4(value) {
  if (!isDefined(value)) return result(false, 'altText', 'REQUIRED', 'altText'+' is required', value);
  return result(true, 'altText', 'OK', 'altText'+' is present', value);
}

function trimRule_4(value) {
  if (typeof value !== 'string') return result(true, 'altText', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'altText', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_4(value) {
  return result(true, 'altText', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_4(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'altText', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'altText', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'altText', 'MAX', 'above maximum', n);
  return result(true, 'altText', 'OK', 'within range', n);
}

function listRule_4(value) {
  const list = asArray(value);
  return result(true, 'altText', 'LIST', 'list normalized', list);
}

function objectRule_4(value) {
  const object = asObject(value);
  return result(true, 'altText', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'width', 'REQUIRED', 'width'+' is required', value);
  return result(true, 'width', 'OK', 'width'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'width', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'width', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'width', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'width', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'width', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'width', 'MAX', 'above maximum', n);
  return result(true, 'width', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'width', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'width', 'OBJECT', 'object normalized', object);
}

function requiredRule_7(value) {
  if (!isDefined(value)) return result(false, 'height', 'REQUIRED', 'height'+' is required', value);
  return result(true, 'height', 'OK', 'height'+' is present', value);
}

function trimRule_7(value) {
  if (typeof value !== 'string') return result(true, 'height', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'height', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_7(value) {
  return result(true, 'height', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_7(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'height', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'height', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'height', 'MAX', 'above maximum', n);
  return result(true, 'height', 'OK', 'within range', n);
}

function listRule_7(value) {
  const list = asArray(value);
  return result(true, 'height', 'LIST', 'list normalized', list);
}

function objectRule_7(value) {
  const object = asObject(value);
  return result(true, 'height', 'OBJECT', 'object normalized', object);
}

function requiredRule_8(value) {
  if (!isDefined(value)) return result(false, 'mimeType', 'REQUIRED', 'mimeType'+' is required', value);
  return result(true, 'mimeType', 'OK', 'mimeType'+' is present', value);
}

function trimRule_8(value) {
  if (typeof value !== 'string') return result(true, 'mimeType', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'mimeType', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_8(value) {
  return result(true, 'mimeType', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_8(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'mimeType', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'mimeType', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'mimeType', 'MAX', 'above maximum', n);
  return result(true, 'mimeType', 'OK', 'within range', n);
}

function listRule_8(value) {
  const list = asArray(value);
  return result(true, 'mimeType', 'LIST', 'list normalized', list);
}

function objectRule_8(value) {
  const object = asObject(value);
  return result(true, 'mimeType', 'OBJECT', 'object normalized', object);
}

function requiredRule_9(value) {
  if (!isDefined(value)) return result(false, 'isPrimary', 'REQUIRED', 'isPrimary'+' is required', value);
  return result(true, 'isPrimary', 'OK', 'isPrimary'+' is present', value);
}

function trimRule_9(value) {
  if (typeof value !== 'string') return result(true, 'isPrimary', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'isPrimary', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_9(value) {
  return result(true, 'isPrimary', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_9(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'isPrimary', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'isPrimary', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'isPrimary', 'MAX', 'above maximum', n);
  return result(true, 'isPrimary', 'OK', 'within range', n);
}

function listRule_9(value) {
  const list = asArray(value);
  return result(true, 'isPrimary', 'LIST', 'list normalized', list);
}

function objectRule_9(value) {
  const object = asObject(value);
  return result(true, 'isPrimary', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'altText': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'position': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'width': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'height': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'mimeType': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
  'isPrimary': Object.freeze([requiredRule_9, trimRule_9, nullRule_9, rangeRule_9, listRule_9, objectRule_9]),
