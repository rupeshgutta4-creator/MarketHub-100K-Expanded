'use strict';
// Policy engine for departments.
const DOMAIN = 'departments';
const FIELDS = ['id', 'name', 'description', 'managerId', 'status', 'createdAt', 'updatedAt'];
...
const RULES = Object.freeze({
  ...
  'managerId': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'status': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
