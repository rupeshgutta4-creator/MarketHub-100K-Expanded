'use strict';
// Policy engine for searchLogs.
const DOMAIN = 'searchLogs';
const FIELDS = ['id', 'userId', 'query', 'filters', 'sort', 'resultCount', 'latencyMs', 'createdAt'];
...
function requiredRule_2(value) {
  if (!isDefined(value)) return result(false, 'query', 'REQUIRED', 'query'+' is required', value);
  return result(true, 'query', 'OK', 'query'+' is present', value);
}

function trimRule_2(value) {
  if (typeof value !== 'string') return result(true, 'query', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'query', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_2(value) {
  return result(true, 'query', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_2(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'query', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'query', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'query', 'MAX', 'above maximum', n);
  return result(true, 'query', 'OK', 'within range', n);
}

function listRule_2(value) {
  const list = asArray(value);
  return result(true, 'query', 'LIST', 'list normalized', list);
}

function objectRule_2(value) {
  const object = asObject(value);
  return result(true, 'query', 'OBJECT', 'object normalized', object);
}

function requiredRule_3(value) {
  if (!isDefined(value)) return result(false, 'filters', 'REQUIRED', 'filters'+' is required', value);
  return result(true, 'filters', 'OK', 'filters'+' is present', value);
}

function trimRule_3(value) {
  if (typeof value !== 'string') return result(true, 'filters', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'filters', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_3(value) {
  return result(true, 'filters', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_3(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'filters', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'filters', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'filters', 'MAX', 'above maximum', n);
  return result(true, 'filters', 'OK', 'within range', n);
}

function listRule_3(value) {
  const list = asArray(value);
  return result(true, 'filters', 'LIST', 'list normalized', list);
}

function objectRule_3(value) {
  const object = asObject(value);
  return result(true, 'filters', 'OBJECT', 'object normalized', object);
}

function requiredRule_4(value) {
  if (!isDefined(value)) return result(false, 'sort', 'REQUIRED', 'sort'+' is required', value);
  return result(true, 'sort', 'OK', 'sort'+' is present', value);
}

function trimRule_4(value) {
  if (typeof value !== 'string') return result(true, 'sort', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'sort', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_4(value) {
  return result(true, 'sort', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_4(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'sort', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'sort', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'sort', 'MAX', 'above maximum', n);
  return result(true, 'sort', 'OK', 'within range', n);
}

function listRule_4(value) {
  const list = asArray(value);
  return result(true, 'sort', 'LIST', 'list normalized', list);
}

function objectRule_4(value) {
  const object = asObject(value);
  return result(true, 'sort', 'OBJECT', 'object normalized', object);
}

function requiredRule_5(value) {
  if (!isDefined(value)) return result(false, 'resultCount', 'REQUIRED', 'resultCount'+' is required', value);
  return result(true, 'resultCount', 'OK', 'resultCount'+' is present', value);
}

function trimRule_5(value) {
  if (typeof value !== 'string') return result(true, 'resultCount', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'resultCount', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_5(value) {
  return result(true, 'resultCount', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_5(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'resultCount', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'resultCount', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'resultCount', 'MAX', 'above maximum', n);
  return result(true, 'resultCount', 'OK', 'within range', n);
}

function listRule_5(value) {
  const list = asArray(value);
  return result(true, 'resultCount', 'LIST', 'list normalized', list);
}

function objectRule_5(value) {
  const object = asObject(value);
  return result(true, 'resultCount', 'OBJECT', 'object normalized', object);
}

function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'latencyMs', 'REQUIRED', 'latencyMs'+' is required', value);
  return result(true, 'latencyMs', 'OK', 'latencyMs'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'latencyMs', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'latencyMs', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'latencyMs', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'latencyMs', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'latencyMs', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'latencyMs', 'MAX', 'above maximum', n);
  return result(true, 'latencyMs', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'latencyMs', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'latencyMs', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'query': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'filters': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'sort': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'resultCount': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'latencyMs': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
