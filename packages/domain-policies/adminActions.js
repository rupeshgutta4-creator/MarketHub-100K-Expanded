'use strict';
// Policy engine for adminActions.
const DOMAIN = 'adminActions';
const FIELDS = ['id', 'adminId', 'action', 'entityType', 'entityId', 'before', 'after', 'ipAddress', 'userAgent', 'createdAt'];
...
function requiredRule_1(value) {
  if (!isDefined(value)) return result(false, 'adminId', 'REQUIRED', 'adminId'+' is required', value);
  return result(true, 'adminId', 'OK', 'adminId'+' is present', value);
}

function trimRule_1(value) {
  if (typeof value !== 'string') return result(true, 'adminId', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'adminId', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_1(value) {
  return result(true, 'adminId', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_1(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'adminId', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'adminId', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'adminId', 'MAX', 'above maximum', n);
  return result(true, 'adminId', 'OK', 'within range', n);
}

function listRule_1(value) {
  const list = asArray(value);
  return result(true, 'adminId', 'LIST', 'list normalized', list);
}

function objectRule_1(value) {
  const object = asObject(value);
  return result(true, 'adminId', 'OBJECT', 'object normalized', object);
}

function requiredRule_2(value) {
  if (!isDefined(value)) return result(false, 'action', 'REQUIRED', 'action'+' is required', value);
  return result(true, 'action', 'OK', 'action'+' is present', value);
}

function trimRule_2(value) {
  if (typeof value !== 'string') return result(true, 'action', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'action', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_2(value) {
  return result(true, 'action', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_2(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'action', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'action', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'action', 'MAX', 'above maximum', n);
  return result(true, 'action', 'OK', 'within range', n);
}

function listRule_2(value) {
  const list = asArray(value);
  return result(true, 'action', 'LIST', 'list normalized', list);
}

function objectRule_2(value) {
  const object = asObject(value);
  return result(true, 'action', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_5(value) {
  if (!isDefined(value)) return result(false, 'before', 'REQUIRED', 'before'+' is required', value);
  return result(true, 'before', 'OK', 'before'+' is present', value);
}

function trimRule_5(value) {
  if (typeof value !== 'string') return result(true, 'before', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'before', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_5(value) {
  return result(true, 'before', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_5(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'before', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'before', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'before', 'MAX', 'above maximum', n);
  return result(true, 'before', 'OK', 'within range', n);
}

function listRule_5(value) {
  const list = asArray(value);
  return result(true, 'before', 'LIST', 'list normalized', list);
}

function objectRule_5(value) {
  const object = asObject(value);
  return result(true, 'before', 'OBJECT', 'object normalized', object);
}

function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'after', 'REQUIRED', 'after'+' is required', value);
  return result(true, 'after', 'OK', 'after'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'after', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'after', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'after', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'after', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'after', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'after', 'MAX', 'above maximum', n);
  return result(true, 'after', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'after', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'after', 'OBJECT', 'object normalized', object);
}

function requiredRule_7(value) {
  if (!isDefined(value)) return result(false, 'ipAddress', 'REQUIRED', 'ipAddress'+' is required', value);
  return result(true, 'ipAddress', 'OK', 'ipAddress'+' is present', value);
}

function trimRule_7(value) {
  if (typeof value !== 'string') return result(true, 'ipAddress', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'ipAddress', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_7(value) {
  return result(true, 'ipAddress', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_7(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'ipAddress', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'ipAddress', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'ipAddress', 'MAX', 'above maximum', n);
  return result(true, 'ipAddress', 'OK', 'within range', n);
}

function listRule_7(value) {
  const list = asArray(value);
  return result(true, 'ipAddress', 'LIST', 'list normalized', list);
}

function objectRule_7(value) {
  const object = asObject(value);
  return result(true, 'ipAddress', 'OBJECT', 'object normalized', object);
}

function requiredRule_8(value) {
  if (!isDefined(value)) return result(false, 'userAgent', 'REQUIRED', 'userAgent'+' is required', value);
  return result(true, 'userAgent', 'OK', 'userAgent'+' is present', value);
}

function trimRule_8(value) {
  if (typeof value !== 'string') return result(true, 'userAgent', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'userAgent', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_8(value) {
  return result(true, 'userAgent', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_8(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'userAgent', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'userAgent', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'userAgent', 'MAX', 'above maximum', n);
  return result(true, 'userAgent', 'OK', 'within range', n);
}

function listRule_8(value) {
  const list = asArray(value);
  return result(true, 'userAgent', 'LIST', 'list normalized', list);
}

function objectRule_8(value) {
  const object = asObject(value);
  return result(true, 'userAgent', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'adminId': Object.freeze([requiredRule_1, trimRule_1, nullRule_1, rangeRule_1, listRule_1, objectRule_1]),
  'action': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'entityType': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'entityId': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'before': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'after': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'ipAddress': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'userAgent': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
