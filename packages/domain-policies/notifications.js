'use strict';
// Policy engine for notifications.
const DOMAIN = 'notifications';
const FIELDS = ['id', 'userId', 'type', 'title', 'message', 'data', 'readAt', 'channel', 'status', 'createdAt'];
...
function requiredRule_4(value) {
  if (!isDefined(value)) return result(false, 'message', 'REQUIRED', 'message'+' is required', value);
  return result(true, 'message', 'OK', 'message'+' is present', value);
}

function trimRule_4(value) {
  if (typeof value !== 'string') return result(true, 'message', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'message', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_4(value) {
  return result(true, 'message', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_4(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'message', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'message', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'message', 'MAX', 'above maximum', n);
  return result(true, 'message', 'OK', 'within range', n);
}

function listRule_4(value) {
  const list = asArray(value);
  return result(true, 'message', 'LIST', 'list normalized', list);
}

function objectRule_4(value) {
  const object = asObject(value);
  return result(true, 'message', 'OBJECT', 'object normalized', object);
}

function requiredRule_5(value) {
  if (!isDefined(value)) return result(false, 'data', 'REQUIRED', 'data'+' is required', value);
  return result(true, 'data', 'OK', 'data'+' is present', value);
}

function trimRule_5(value) {
  if (typeof value !== 'string') return result(true, 'data', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'data', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_5(value) {
  return result(true, 'data', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_5(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'data', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'data', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'data', 'MAX', 'above maximum', n);
  return result(true, 'data', 'OK', 'within range', n);
}

function listRule_5(value) {
  const list = asArray(value);
  return result(true, 'data', 'LIST', 'list normalized', list);
}

function objectRule_5(value) {
  const object = asObject(value);
  return result(true, 'data', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_7(value) {
  if (!isDefined(value)) return result(false, 'channel', 'REQUIRED', 'channel'+' is required', value);
  return result(true, 'channel', 'OK', 'channel'+' is present', value);
}

function trimRule_7(value) {
  if (typeof value !== 'string') return result(true, 'channel', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'channel', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_7(value) {
  return result(true, 'channel', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_7(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'channel', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'channel', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'channel', 'MAX', 'above maximum', n);
  return result(true, 'channel', 'OK', 'within range', n);
}

function listRule_7(value) {
  const list = asArray(value);
  return result(true, 'channel', 'LIST', 'list normalized', list);
}

function objectRule_7(value) {
  const object = asObject(value);
  return result(true, 'channel', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'title': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'message': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'data': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'readAt': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'channel': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
