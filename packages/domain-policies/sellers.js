'use strict';
// Policy engine for sellers.
const DOMAIN = 'sellers';
const FIELDS = ['id', 'userId', 'shopName', 'legalName', 'taxId', 'email', 'phone', 'status', 'rating', 'commissionRate', 'bankAccount', 'payoutSchedule', 'createdAt', 'updatedAt'];
...
function requiredRule_9(value) {
  if (!isDefined(value)) return result(false, 'commissionRate', 'REQUIRED', 'commissionRate'+' is required', value);
  return result(true, 'commissionRate', 'OK', 'commissionRate'+' is present', value);
}

function trimRule_9(value) {
  if (typeof value !== 'string') return result(true, 'commissionRate', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'commissionRate', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_9(value) {
  return result(true, 'commissionRate', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_9(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'commissionRate', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'commissionRate', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'commissionRate', 'MAX', 'above maximum', n);
  return result(true, 'commissionRate', 'OK', 'within range', n);
}

function listRule_9(value) {
  const list = asArray(value);
  return result(true, 'commissionRate', 'LIST', 'list normalized', list);
}

function objectRule_9(value) {
  const object = asObject(value);
  return result(true, 'commissionRate', 'OBJECT', 'object normalized', object);
}

function requiredRule_10(value) {
  if (!isDefined(value)) return result(false, 'bankAccount', 'REQUIRED', 'bankAccount'+' is required', value);
  return result(true, 'bankAccount', 'OK', 'bankAccount'+' is present', value);
}

function trimRule_10(value) {
  if (typeof value !== 'string') return result(true, 'bankAccount', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'bankAccount', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_10(value) {
  return result(true, 'bankAccount', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_10(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'bankAccount', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'bankAccount', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'bankAccount', 'MAX', 'above maximum', n);
  return result(true, 'bankAccount', 'OK', 'within range', n);
}

function listRule_10(value) {
  const list = asArray(value);
  return result(true, 'bankAccount', 'LIST', 'list normalized', list);
}

function objectRule_10(value) {
  const object = asObject(value);
  return result(true, 'bankAccount', 'OBJECT', 'object normalized', object);
}

function requiredRule_11(value) {
  if (!isDefined(value)) return result(false, 'payoutSchedule', 'REQUIRED', 'payoutSchedule'+' is required', value);
  return result(true, 'payoutSchedule', 'OK', 'payoutSchedule'+' is present', value);
}

function trimRule_11(value) {
  if (typeof value !== 'string') return result(true, 'payoutSchedule', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'payoutSchedule', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_11(value) {
  return result(true, 'payoutSchedule', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_11(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'payoutSchedule', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'payoutSchedule', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'payoutSchedule', 'MAX', 'above maximum', n);
  return result(true, 'payoutSchedule', 'OK', 'within range', n);
}

function listRule_11(value) {
  const list = asArray(value);
  return result(true, 'payoutSchedule', 'LIST', 'list normalized', list);
}

function objectRule_11(value) {
  const object = asObject(value);
  return result(true, 'payoutSchedule', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'email': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'phone': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'status': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'rating': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
  'commissionRate': Object.freeze([requiredRule_9, trimRule_9, nullRule_9, rangeRule_9, listRule_9, objectRule_9]),
  'bankAccount': Object.freeze([requiredRule_10, trimRule_10, nullRule_10, rangeRule_10, listRule_10, objectRule_10]),
  'payoutSchedule': Object.freeze([requiredRule_11, trimRule_11, nullRule_11, rangeRule_11, listRule_11, objectRule_11]),
