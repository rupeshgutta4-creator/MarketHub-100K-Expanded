...
function requiredRule_5(value) {
  if (!isDefined(value)) return result(false, 'trackingNumber', 'REQUIRED', 'trackingNumber'+' is required', value);
  return result(true, 'trackingNumber', 'OK', 'trackingNumber'+' is present', value);
}

function trimRule_5(value) {
  if (typeof value !== 'string') return result(true, 'trackingNumber', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'trackingNumber', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_5(value) {
  return result(true, 'trackingNumber', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_5(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'trackingNumber', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'trackingNumber', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'trackingNumber', 'MAX', 'above maximum', n);
  return result(true, 'trackingNumber', 'OK', 'within range', n);
}

function listRule_5(value) {
  const list = asArray(value);
  return result(true, 'trackingNumber', 'LIST', 'list normalized', list);
}

function objectRule_5(value) {
  const object = asObject(value);
  return result(true, 'trackingNumber', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_7(value) {
  if (!isDefined(value)) return result(false, 'shippingCost', 'REQUIRED', 'shippingCost'+' is required', value);
  return result(true, 'shippingCost', 'OK', 'shippingCost'+' is present', value);
}

function trimRule_7(value) {
  if (typeof value !== 'string') return result(true, 'shippingCost', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'shippingCost', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_7(value) {
  return result(true, 'shippingCost', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_7(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'shippingCost', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'shippingCost', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'shippingCost', 'MAX', 'above maximum', n);
  return result(true, 'shippingCost', 'OK', 'within range', n);
}

function listRule_7(value) {
  const list = asArray(value);
  return result(true, 'shippingCost', 'LIST', 'list normalized', list);
}

function objectRule_7(value) {
  const object = asObject(value);
  return result(true, 'shippingCost', 'OBJECT', 'object normalized', object);
}

function requiredRule_8(value) {
  if (!isDefined(value)) return result(false, 'labelUrl', 'REQUIRED', 'labelUrl'+' is required', value);
  return result(true, 'labelUrl', 'OK', 'labelUrl'+' is present', value);
}

function trimRule_8(value) {
  if (typeof value !== 'string') return result(true, 'labelUrl', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'labelUrl', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_8(value) {
  return result(true, 'labelUrl', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_8(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'labelUrl', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'labelUrl', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'labelUrl', 'MAX', 'above maximum', n);
  return result(true, 'labelUrl', 'OK', 'within range', n);
}

function listRule_8(value) {
  const list = asArray(value);
  return result(true, 'labelUrl', 'LIST', 'list normalized', list);
}

function objectRule_8(value) {
  const object = asObject(value);
  return result(true, 'labelUrl', 'OBJECT', 'object normalized', object);
}

function requiredRule_9(value) {
  if (!isDefined(value)) return result(false, 'estimatedDelivery', 'REQUIRED', 'estimatedDelivery'+' is required', value);
  return result(true, 'estimatedDelivery', 'OK', 'estimatedDelivery'+' is present', value);
}

function trimRule_9(value) {
  if (typeof value !== 'string') return result(true, 'estimatedDelivery', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'estimatedDelivery', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_9(value) {
  return result(true, 'estimatedDelivery', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_9(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'estimatedDelivery', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'estimatedDelivery', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'estimatedDelivery', 'MAX', 'above maximum', n);
  return result(true, 'estimatedDelivery', 'OK', 'within range', n);
}

function listRule_9(value) {
  const list = asArray(value);
  return result(true, 'estimatedDelivery', 'LIST', 'list normalized', list);
}

function objectRule_9(value) {
  const object = asObject(value);
  return result(true, 'estimatedDelivery', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'sellerId': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'carrier': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'service': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'trackingNumber': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'status': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'shippingCost': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'labelUrl': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
  'estimatedDelivery': Object.freeze([requiredRule_9, trimRule_9, nullRule_9, rangeRule_9, listRule_9, objectRule_9]),
  'shippedAt': Object.freeze([requiredRule_10, trimRule_10, nullRule_10, rangeRule_10, listRule_10, objectRule_10]),
  'deliveredAt': Object.freeze([requiredRule_11, trimRule_11, nullRule_11, rangeRule_11, listRule_11, objectRule_11]),
