'use strict';
// Policy engine for reports.
const DOMAIN = 'reports';
const FIELDS = ['id', 'name', 'type', 'parameters', 'format', 'status', 'fileUrl', 'requestedBy', 'generatedAt', 'createdAt'];
...
function requiredRule_3(value) {
  if (!isDefined(value)) return result(false, 'parameters', 'REQUIRED', 'parameters'+' is required', value);
  return result(true, 'parameters', 'OK', 'parameters'+' is present', value);
}

function trimRule_3(value) {
  if (typeof value !== 'string') return result(true, 'parameters', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'parameters', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_3(value) {
  return result(true, 'parameters', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_3(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'parameters', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'parameters', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'parameters', 'MAX', 'above maximum', n);
  return result(true, 'parameters', 'OK', 'within range', n);
}

function listRule_3(value) {
  const list = asArray(value);
  return result(true, 'parameters', 'LIST', 'list normalized', list);
}

function objectRule_3(value) {
  const object = asObject(value);
  return result(true, 'parameters', 'OBJECT', 'object normalized', object);
}

function requiredRule_4(value) {
  if (!isDefined(value)) return result(false, 'format', 'REQUIRED', 'format'+' is required', value);
  return result(true, 'format', 'OK', 'format'+' is present', value);
}

function trimRule_4(value) {
  if (typeof value !== 'string') return result(true, 'format', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'format', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_4(value) {
  return result(true, 'format', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_4(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'format', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'format', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'format', 'MAX', 'above maximum', n);
  return result(true, 'format', 'OK', 'within range', n);
}

function listRule_4(value) {
  const list = asArray(value);
  return result(true, 'format', 'LIST', 'list normalized', list);
}

function objectRule_4(value) {
  const object = asObject(value);
  return result(true, 'format', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'fileUrl', 'REQUIRED', 'fileUrl'+' is required', value);
  return result(true, 'fileUrl', 'OK', 'fileUrl'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'fileUrl', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'fileUrl', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'fileUrl', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'fileUrl', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'fileUrl', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'fileUrl', 'MAX', 'above maximum', n);
  return result(true, 'fileUrl', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'fileUrl', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'fileUrl', 'OBJECT', 'object normalized', object);
}

function requiredRule_7(value) {
  if (!isDefined(value)) return result(false, 'requestedBy', 'REQUIRED', 'requestedBy'+' is required', value);
  return result(true, 'requestedBy', 'OK', 'requestedBy'+' is present', value);
}

function trimRule_7(value) {
  if (typeof value !== 'string') return result(true, 'requestedBy', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'requestedBy', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_7(value) {
  return result(true, 'requestedBy', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_7(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'requestedBy', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'requestedBy', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'requestedBy', 'MAX', 'above maximum', n);
  return result(true, 'requestedBy', 'OK', 'within range', n);
}

function listRule_7(value) {
  const list = asArray(value);
  return result(true, 'requestedBy', 'LIST', 'list normalized', list);
}

function objectRule_7(value) {
  const object = asObject(value);
  return result(true, 'requestedBy', 'OBJECT', 'object normalized', object);
}

function requiredRule_8(value) {
  if (!isDefined(value)) return result(false, 'generatedAt', 'REQUIRED', 'generatedAt'+' is required', value);
  return result(true, 'generatedAt', 'OK', 'generatedAt'+' is present', value);
}

function trimRule_8(value) {
  if (typeof value !== 'string') return result(true, 'generatedAt', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'generatedAt', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_8(value) {
  return result(true, 'generatedAt', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_8(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'generatedAt', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'generatedAt', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'generatedAt', 'MAX', 'above maximum', n);
  return result(true, 'generatedAt', 'OK', 'within range', n);
}

function listRule_8(value) {
  const list = asArray(value);
  return result(true, 'generatedAt', 'LIST', 'list normalized', list);
}

function objectRule_8(value) {
  const object = asObject(value);
  return result(true, 'generatedAt', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'name': Object.freeze([requiredRule_1, trimRule_1, nullRule_1, rangeRule_1, listRule_1, objectRule_1]),
  'type': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'parameters': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'format': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'status': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'fileUrl': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'requestedBy': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'generatedAt': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
