...
function requiredRule_1(value) {
  if (!isDefined(value)) return result(false, 'senderId', 'REQUIRED', 'senderId'+' is required', value);
  return result(true, 'senderId', 'OK', 'senderId'+' is present', value);
}

function trimRule_1(value) {
  if (typeof value !== 'string') return result(true, 'senderId', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'senderId', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_1(value) {
  return result(true, 'senderId', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_1(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'senderId', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'senderId', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'senderId', 'MAX', 'above maximum', n);
  return result(true, 'senderId', 'OK', 'within range', n);
}

function listRule_1(value) {
  const list = asArray(value);
  return result(true, 'senderId', 'LIST', 'list normalized', list);
}

function objectRule_1(value) {
  const object = asObject(value);
  return result(true, 'senderId', 'OBJECT', 'object normalized', object);
}

function requiredRule_2(value) {
  if (!isDefined(value)) return result(false, 'receiverId', 'REQUIRED', 'receiverId'+' is required', value);
  return result(true, 'receiverId', 'OK', 'receiverId'+' is present', value);
}

function trimRule_2(value) {
  if (typeof value !== 'string') return result(true, 'receiverId', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'receiverId', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_2(value) {
  return result(true, 'receiverId', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_2(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'receiverId', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'receiverId', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'receiverId', 'MAX', 'above maximum', n);
  return result(true, 'receiverId', 'OK', 'within range', n);
}

function listRule_2(value) {
  const list = asArray(value);
  return result(true, 'receiverId', 'LIST', 'list normalized', list);
}

function objectRule_2(value) {
  const object = asObject(value);
  return result(true, 'receiverId', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'attachments', 'REQUIRED', 'attachments'+' is required', value);
  return result(true, 'attachments', 'OK', 'attachments'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'attachments', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'attachments', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'attachments', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'attachments', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'attachments', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'attachments', 'MAX', 'above maximum', n);
  return result(true, 'attachments', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'attachments', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'attachments', 'OBJECT', 'object normalized', object);
}

function requiredRule_7(value) {
  if (!isDefined(value)) return result(false, 'readAt', 'REQUIRED', 'readAt'+' is required', value);
  return result(true, 'readAt', 'OK', 'readAt'+' is present', value);
}

function trimRule_7(value) {
  if (typeof value !== 'string') return result(true, 'readAt', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'readAt', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_7(value) {
  return result(true, 'readAt', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_7(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'readAt', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'readAt', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'readAt', 'MAX', 'above maximum', n);
  return result(true, 'readAt', 'OK', 'within range', n);
}

function listRule_7(value) {
  const list = asArray(value);
  return result(true, 'readAt', 'LIST', 'list normalized', list);
}

function objectRule_7(value) {
  const object = asObject(value);
  return result(true, 'readAt', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'senderId': Object.freeze([requiredRule_1, trimRule_1, nullRule_1, rangeRule_1, listRule_1, objectRule_1]),
  'receiverId': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'orderId': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'subject': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'body': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'attachments': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'readAt': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
