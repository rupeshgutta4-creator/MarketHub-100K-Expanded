'use strict';
// Policy engine for productAttributes.
const DOMAIN = 'productAttributes';
const FIELDS = ['id', 'name', 'type', 'unit', 'required', 'filterable', 'searchable', 'options', 'createdAt', 'updatedAt'];
...
function requiredRule_3(value) {
  if (!isDefined(value)) return result(false, 'unit', 'REQUIRED', 'unit'+' is required', value);
  return result(true, 'unit', 'OK', 'unit'+' is present', value);
}

function trimRule_3(value) {
  if (typeof value !== 'string') return result(true, 'unit', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'unit', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_3(value) {
  return result(true, 'unit', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_3(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'unit', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'unit', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'unit', 'MAX', 'above maximum', n);
  return result(true, 'unit', 'OK', 'within range', n);
}

function listRule_3(value) {
  const list = asArray(value);
  return result(true, 'unit', 'LIST', 'list normalized', list);
}

function objectRule_3(value) {
  const object = asObject(value);
  return result(true, 'unit', 'OBJECT', 'object normalized', object);
}

function requiredRule_4(value) {
  if (!isDefined(value)) return result(false, 'required', 'REQUIRED', 'required'+' is required', value);
  return result(true, 'required', 'OK', 'required'+' is present', value);
}

function trimRule_4(value) {
  if (typeof value !== 'string') return result(true, 'required', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'required', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_4(value) {
  return result(true, 'required', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_4(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'required', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'required', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'required', 'MAX', 'above maximum', n);
  return result(true, 'required', 'OK', 'within range', n);
}

function listRule_4(value) {
  const list = asArray(value);
  return result(true, 'required', 'LIST', 'list normalized', list);
}

function objectRule_4(value) {
  const object = asObject(value);
  return result(true, 'required', 'OBJECT', 'object normalized', object);
}

function requiredRule_5(value) {
  if (!isDefined(value)) return result(false, 'filterable', 'REQUIRED', 'filterable'+' is required', value);
  return result(true, 'filterable', 'OK', 'filterable'+' is present', value);
}

function trimRule_5(value) {
  if (typeof value !== 'string') return result(true, 'filterable', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'filterable', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_5(value) {
  return result(true, 'filterable', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_5(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'filterable', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'filterable', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'filterable', 'MAX', 'above maximum', n);
  return result(true, 'filterable', 'OK', 'within range', n);
}

function listRule_5(value) {
  const list = asArray(value);
  return result(true, 'filterable', 'LIST', 'list normalized', list);
}

function objectRule_5(value) {
  const object = asObject(value);
  return result(true, 'filterable', 'OBJECT', 'object normalized', object);
}

function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'searchable', 'REQUIRED', 'searchable'+' is required', value);
  return result(true, 'searchable', 'OK', 'searchable'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'searchable', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'searchable', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'searchable', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'searchable', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'searchable', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'searchable', 'MAX', 'above maximum', n);
  return result(true, 'searchable', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'searchable', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'searchable', 'OBJECT', 'object normalized', object);
}

function requiredRule_7(value) {
  if (!isDefined(value)) return result(false, 'options', 'REQUIRED', 'options'+' is required', value);
  return result(true, 'options', 'OK', 'options'+' is present', value);
}

function trimRule_7(value) {
  if (typeof value !== 'string') return result(true, 'options', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'options', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_7(value) {
  return result(true, 'options', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_7(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'options', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'options', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'options', 'MAX', 'above maximum', n);
  return result(true, 'options', 'OK', 'within range', n);
}

function listRule_7(value) {
  const list = asArray(value);
  return result(true, 'options', 'LIST', 'list normalized', list);
}

function objectRule_7(value) {
  const object = asObject(value);
  return result(true, 'options', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'unit': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'required': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'filterable': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'searchable': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'options': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
