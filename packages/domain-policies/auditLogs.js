'use strict';
// Policy engine for auditLogs.
const DOMAIN = 'auditLogs';
const FIELDS = ['id', 'actorId', 'action', 'entity', 'entityId', 'metadata', 'ipAddress', 'userAgent', 'createdAt'];
...
function requiredRule_1(value) {
  if (!isDefined(value)) return result(false, 'actorId', 'REQUIRED', 'actorId'+' is required', value);
  return result(true, 'actorId', 'OK', 'actorId'+' is present', value);
}

function trimRule_1(value) {
  if (typeof value !== 'string') return result(true, 'actorId', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'actorId', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_1(value) {
  return result(true, 'actorId', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_1(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'actorId', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'actorId', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'actorId', 'MAX', 'above maximum', n);
  return result(true, 'actorId', 'OK', 'within range', n);
}

function listRule_1(value) {
  const list = asArray(value);
  return result(true, 'actorId', 'LIST', 'list normalized', list);
}

function objectRule_1(value) {
  const object = asObject(value);
  return result(true, 'actorId', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_3(value) {
  if (!isDefined(value)) return result(false, 'entity', 'REQUIRED', 'entity'+' is required', value);
  return result(true, 'entity', 'OK', 'entity'+' is present', value);
}

function trimRule_3(value) {
  if (typeof value !== 'string') return result(true, 'entity', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'entity', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_3(value) {
  return result(true, 'entity', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_3(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'entity', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'entity', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'entity', 'MAX', 'above maximum', n);
  return result(true, 'entity', 'OK', 'within range', n);
}

function listRule_3(value) {
  const list = asArray(value);
  return result(true, 'entity', 'LIST', 'list normalized', list);
}

function objectRule_3(value) {
  const object = asObject(value);
  return result(true, 'entity', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_5(value) {
  if (!isDefined(value)) return result(false, 'metadata', 'REQUIRED', 'metadata'+' is required', value);
  return result(true, 'metadata', 'OK', 'metadata'+' is present', value);
}

function trimRule_5(value) {
  if (typeof value !== 'string') return result(true, 'metadata', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'metadata', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_5(value) {
  return result(true, 'metadata', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_5(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'metadata', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'metadata', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'metadata', 'MAX', 'above maximum', n);
  return result(true, 'metadata', 'OK', 'within range', n);
}

function listRule_5(value) {
  const list = asArray(value);
  return result(true, 'metadata', 'LIST', 'list normalized', list);
}

function objectRule_5(value) {
  const object = asObject(value);
  return result(true, 'metadata', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'actorId': Object.freeze([requiredRule_1, trimRule_1, nullRule_1, rangeRule_1, listRule_1, objectRule_1]),
  'action': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'entity': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'entityId': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'metadata': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'ipAddress': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'userAgent': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
