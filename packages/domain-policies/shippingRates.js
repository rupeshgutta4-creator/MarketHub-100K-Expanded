'use strict';
// Policy engine for shippingRates.
...
function requiredRule_1(value) {
  if (!isDefined(value)) return result(false, 'zoneId', 'REQUIRED', 'zoneId'+' is required', value);
  return result(true, 'zoneId', 'OK', 'zoneId'+' is present', value);
}

function trimRule_1(value) {
  if (typeof value !== 'string') return result(true, 'zoneId', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'zoneId', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_1(value) {
  return result(true, 'zoneId', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_1(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'zoneId', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'zoneId', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'zoneId', 'MAX', 'above maximum', n);
  return result(true, 'zoneId', 'OK', 'within range', n);
}

function listRule_1(value) {
  const list = asArray(value);
  return result(true, 'zoneId', 'LIST', 'list normalized', list);
}

function objectRule_1(value) {
  const object = asObject(value);
  return result(true, 'zoneId', 'OBJECT', 'object normalized', object);
}

function requiredRule_2(value) {
  if (!isDefined(value)) return result(false, 'carrier', 'REQUIRED', 'carrier'+' is required', value);
  return result(true, 'carrier', 'OK', 'carrier'+' is present', value);
}

function trimRule_2(value) {
  if (typeof value !== 'string') return result(true, 'carrier', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'carrier', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_2(value) {
  return result(true, 'carrier', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_2(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'carrier', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'carrier', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'carrier', 'MAX', 'above maximum', n);
  return result(true, 'carrier', 'OK', 'within range', n);
}

function listRule_2(value) {
  const list = asArray(value);
  return result(true, 'carrier', 'LIST', 'list normalized', list);
}

function objectRule_2(value) {
  const object = asObject(value);
  return result(true, 'carrier', 'OBJECT', 'object normalized', object);
}

function requiredRule_3(value) {
  if (!isDefined(value)) return result(false, 'service', 'REQUIRED', 'service'+' is required', value);
  return result(true, 'service', 'OK', 'service'+' is present', value);
}

function trimRule_3(value) {
  if (typeof value !== 'string') return result(true, 'service', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'service', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_3(value) {
  return result(true, 'service', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_3(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'service', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'service', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'service', 'MAX', 'above maximum', n);
  return result(true, 'service', 'OK', 'within range', n);
}

function listRule_3(value) {
  const list = asArray(value);
  return result(true, 'service', 'LIST', 'list normalized', list);
}

function objectRule_3(value) {
  const object = asObject(value);
  return result(true, 'service', 'OBJECT', 'object normalized', object);
}

function requiredRule_4(value) {
  if (!isDefined(value)) return result(false, 'minWeight', 'REQUIRED', 'minWeight'+' is required', value);
  return result(true, 'minWeight', 'OK', 'minWeight'+' is present', value);
}

function trimRule_4(value) {
  if (typeof value !== 'string') return result(true, 'minWeight', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'minWeight', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_4(value) {
  return result(true, 'minWeight', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_4(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'minWeight', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'minWeight', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'minWeight', 'MAX', 'above maximum', n);
  return result(true, 'minWeight', 'OK', 'within range', n);
}

function listRule_4(value) {
  const list = asArray(value);
  return result(true, 'minWeight', 'LIST', 'list normalized', list);
}

function objectRule_4(value) {
  const object = asObject(value);
  return result(true, 'minWeight', 'OBJECT', 'object normalized', object);
}

function requiredRule_5(value) {
  if (!isDefined(value)) return result(false, 'maxWeight', 'REQUIRED', 'maxWeight'+' is required', value);
  return result(true, 'maxWeight', 'OK', 'maxWeight'+' is present', value);
}

function trimRule_5(value) {
  if (typeof value !== 'string') return result(true, 'maxWeight', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'maxWeight', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_5(value) {
  return result(true, 'maxWeight', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_5(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'maxWeight', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'maxWeight', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'maxWeight', 'MAX', 'above maximum', n);
  return result(true, 'maxWeight', 'OK', 'within range', n);
}

function listRule_5(value) {
  const list = asArray(value);
  return result(true, 'maxWeight', 'LIST', 'list normalized', list);
}

function objectRule_5(value) {
  const object = asObject(value);
  return result(true, 'maxWeight', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_7(value) {
  if (!isDefined(value)) return result(false, 'maxOrder', 'REQUIRED', 'maxOrder'+' is required', value);
  return result(true, 'maxOrder', 'OK', 'maxOrder'+' is present', value);
}

function trimRule_7(value) {
  if (typeof value !== 'string') return result(true, 'maxOrder', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'maxOrder', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_7(value) {
  return result(true, 'maxOrder', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_7(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'maxOrder', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'maxOrder', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'maxOrder', 'MAX', 'above maximum', n);
  return result(true, 'maxOrder', 'OK', 'within range', n);
}

function listRule_7(value) {
  const list = asArray(value);
  return result(true, 'maxOrder', 'LIST', 'list normalized', list);
}

function objectRule_7(value) {
  const object = asObject(value);
  return result(true, 'maxOrder', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_9(value) {
  if (!isDefined(value)) return result(false, 'freeThreshold', 'REQUIRED', 'freeThreshold'+' is required', value);
  return result(true, 'freeThreshold', 'OK', 'freeThreshold'+' is present', value);
}

function trimRule_9(value) {
  if (typeof value !== 'string') return result(true, 'freeThreshold', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'freeThreshold', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_9(value) {
  return result(true, 'freeThreshold', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_9(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'freeThreshold', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'freeThreshold', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'freeThreshold', 'MAX', 'above maximum', n);
  return result(true, 'freeThreshold', 'OK', 'within range', n);
}

function listRule_9(value) {
  const list = asArray(value);
  return result(true, 'freeThreshold', 'LIST', 'list normalized', list);
}

function objectRule_9(value) {
  const object = asObject(value);
  return result(true, 'freeThreshold', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'zoneId': Object.freeze([requiredRule_1, trimRule_1, nullRule_1, rangeRule_1, listRule_1, objectRule_1]),
  'carrier': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'service': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'minWeight': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'maxWeight': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'minOrder': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'maxOrder': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'rate': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
  'freeThreshold': Object.freeze([requiredRule_9, trimRule_9, nullRule_9, rangeRule_9, listRule_9, objectRule_9]),
  'active': Object.freeze([requiredRule_10, trimRule_10, nullRule_10, rangeRule_10, listRule_10, objectRule_10]),
