...
function requiredRule_1(value) {
  if (!isDefined(value)) return result(false, 'email', 'REQUIRED', 'email'+' is required', value);
  return result(true, 'email', 'OK', 'email'+' is present', value);
}

function trimRule_1(value) {
  if (typeof value !== 'string') return result(true, 'email', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'email', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_1(value) {
  return result(true, 'email', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_1(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'email', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'email', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'email', 'MAX', 'above maximum', n);
  return result(true, 'email', 'OK', 'within range', n);
}

function listRule_1(value) {
  const list = asArray(value);
  return result(true, 'email', 'LIST', 'list normalized', list);
}

function objectRule_1(value) {
  const object = asObject(value);
  return result(true, 'email', 'OBJECT', 'object normalized', object);
}

function requiredRule_2(value) {
  if (!isDefined(value)) return result(false, 'passwordHash', 'REQUIRED', 'passwordHash'+' is required', value);
  return result(true, 'passwordHash', 'OK', 'passwordHash'+' is present', value);
}

function trimRule_2(value) {
  if (typeof value !== 'string') return result(true, 'passwordHash', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'passwordHash', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_2(value) {
  return result(true, 'passwordHash', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_2(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'passwordHash', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'passwordHash', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'passwordHash', 'MAX', 'above maximum', n);
  return result(true, 'passwordHash', 'OK', 'within range', n);
}

function listRule_2(value) {
  const list = asArray(value);
  return result(true, 'passwordHash', 'LIST', 'list normalized', list);
}

function objectRule_2(value) {
  const object = asObject(value);
  return result(true, 'passwordHash', 'OBJECT', 'object normalized', object);
}

function requiredRule_3(value) {
  if (!isDefined(value)) return result(false, 'firstName', 'REQUIRED', 'firstName'+' is required', value);
  return result(true, 'firstName', 'OK', 'firstName'+' is present', value);
}

function trimRule_3(value) {
  if (typeof value !== 'string') return result(true, 'firstName', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'firstName', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_3(value) {
  return result(true, 'firstName', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_3(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'firstName', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'firstName', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'firstName', 'MAX', 'above maximum', n);
  return result(true, 'firstName', 'OK', 'within range', n);
}

function listRule_3(value) {
  const list = asArray(value);
  return result(true, 'firstName', 'LIST', 'list normalized', list);
}

function objectRule_3(value) {
  const object = asObject(value);
  return result(true, 'firstName', 'OBJECT', 'object normalized', object);
}

function requiredRule_4(value) {
  if (!isDefined(value)) return result(false, 'lastName', 'REQUIRED', 'lastName'+' is required', value);
  return result(true, 'lastName', 'OK', 'lastName'+' is present', value);
}

function trimRule_4(value) {
  if (typeof value !== 'string') return result(true, 'lastName', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'lastName', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_4(value) {
  return result(true, 'lastName', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_4(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'lastName', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'lastName', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'lastName', 'MAX', 'above maximum', n);
  return result(true, 'lastName', 'OK', 'within range', n);
}

function listRule_4(value) {
  const list = asArray(value);
  return result(true, 'lastName', 'LIST', 'list normalized', list);
}

function objectRule_4(value) {
  const object = asObject(value);
  return result(true, 'lastName', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'role', 'REQUIRED', 'role'+' is required', value);
  return result(true, 'role', 'OK', 'role'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'role', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'role', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'role', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'role', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'role', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'role', 'MAX', 'above maximum', n);
  return result(true, 'role', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'role', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'role', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_8(value) {
  if (!isDefined(value)) return result(false, 'avatarUrl', 'REQUIRED', 'avatarUrl'+' is required', value);
  return result(true, 'avatarUrl', 'OK', 'avatarUrl'+' is present', value);
}

function trimRule_8(value) {
  if (typeof value !== 'string') return result(true, 'avatarUrl', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'avatarUrl', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_8(value) {
  return result(true, 'avatarUrl', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_8(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'avatarUrl', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'avatarUrl', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'avatarUrl', 'MAX', 'above maximum', n);
  return result(true, 'avatarUrl', 'OK', 'within range', n);
}

function listRule_8(value) {
  const list = asArray(value);
  return result(true, 'avatarUrl', 'LIST', 'list normalized', list);
}

function objectRule_8(value) {
  const object = asObject(value);
  return result(true, 'avatarUrl', 'OBJECT', 'object normalized', object);
}

function requiredRule_9(value) {
  if (!isDefined(value)) return result(false, 'lastLoginAt', 'REQUIRED', 'lastLoginAt'+' is required', value);
  return result(true, 'lastLoginAt', 'OK', 'lastLoginAt'+' is present', value);
}

function trimRule_9(value) {
  if (typeof value !== 'string') return result(true, 'lastLoginAt', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'lastLoginAt', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_9(value) {
  return result(true, 'lastLoginAt', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_9(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'lastLoginAt', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'lastLoginAt', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'lastLoginAt', 'MAX', 'above maximum', n);
  return result(true, 'lastLoginAt', 'OK', 'within range', n);
}

function listRule_9(value) {
  const list = asArray(value);
  return result(true, 'lastLoginAt', 'LIST', 'list normalized', list);
}

function objectRule_9(value) {
  const object = asObject(value);
  return result(true, 'lastLoginAt', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'email': Object.freeze([requiredRule_1, trimRule_1, nullRule_1, rangeRule_1, listRule_1, objectRule_1]),
  'passwordHash': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'firstName': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'lastName': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'phone': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'role': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'status': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'avatarUrl': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
  'lastLoginAt': Object.freeze([requiredRule_9, trimRule_9, nullRule_9, rangeRule_9, listRule_9, objectRule_9]),
