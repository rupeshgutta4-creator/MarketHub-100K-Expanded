'use strict';
// Policy engine for webhooks.
const DOMAIN = 'webhooks';
const FIELDS = ['id', 'name', 'url', 'events', 'secretHash', 'status', 'lastDeliveredAt', 'failureCount', 'createdAt', 'updatedAt'];
...
function requiredRule_3(value) {
  if (!isDefined(value)) return result(false, 'events', 'REQUIRED', 'events'+' is required', value);
  return result(true, 'events', 'OK', 'events'+' is present', value);
}

function trimRule_3(value) {
  if (typeof value !== 'string') return result(true, 'events', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'events', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_3(value) {
  return result(true, 'events', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_3(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'events', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'events', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'events', 'MAX', 'above maximum', n);
  return result(true, 'events', 'OK', 'within range', n);
}

function listRule_3(value) {
  const list = asArray(value);
  return result(true, 'events', 'LIST', 'list normalized', list);
}

function objectRule_3(value) {
  const object = asObject(value);
  return result(true, 'events', 'OBJECT', 'object normalized', object);
}

function requiredRule_4(value) {
  if (!isDefined(value)) return result(false, 'secretHash', 'REQUIRED', 'secretHash'+' is required', value);
  return result(true, 'secretHash', 'OK', 'secretHash'+' is present', value);
}

function trimRule_4(value) {
  if (typeof value !== 'string') return result(true, 'secretHash', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'secretHash', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_4(value) {
  return result(true, 'secretHash', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_4(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'secretHash', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'secretHash', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'secretHash', 'MAX', 'above maximum', n);
  return result(true, 'secretHash', 'OK', 'within range', n);
}

function listRule_4(value) {
  const list = asArray(value);
  return result(true, 'secretHash', 'LIST', 'list normalized', list);
}

function objectRule_4(value) {
  const object = asObject(value);
  return result(true, 'secretHash', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'lastDeliveredAt', 'REQUIRED', 'lastDeliveredAt'+' is required', value);
  return result(true, 'lastDeliveredAt', 'OK', 'lastDeliveredAt'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'lastDeliveredAt', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'lastDeliveredAt', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'lastDeliveredAt', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'lastDeliveredAt', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'lastDeliveredAt', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'lastDeliveredAt', 'MAX', 'above maximum', n);
  return result(true, 'lastDeliveredAt', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'lastDeliveredAt', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'lastDeliveredAt', 'OBJECT', 'object normalized', object);
}

function requiredRule_7(value) {
  if (!isDefined(value)) return result(false, 'failureCount', 'REQUIRED', 'failureCount'+' is required', value);
  return result(true, 'failureCount', 'OK', 'failureCount'+' is present', value);
}

function trimRule_7(value) {
  if (typeof value !== 'string') return result(true, 'failureCount', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'failureCount', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_7(value) {
  return result(true, 'failureCount', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_7(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'failureCount', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'failureCount', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'failureCount', 'MAX', 'above maximum', n);
  return result(true, 'failureCount', 'OK', 'within range', n);
}

function listRule_7(value) {
  const list = asArray(value);
  return result(true, 'failureCount', 'LIST', 'list normalized', list);
}

function objectRule_7(value) {
  const object = asObject(value);
  return result(true, 'failureCount', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'url': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'events': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'secretHash': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'status': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'lastDeliveredAt': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'failureCount': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
