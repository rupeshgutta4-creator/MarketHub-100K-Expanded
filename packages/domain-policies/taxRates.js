...
function requiredRule_7(value) {
  if (!isDefined(value)) return result(false, 'inclusive', 'REQUIRED', 'inclusive'+' is required', value);
  return result(true, 'inclusive', 'OK', 'inclusive'+' is present', value);
}

function trimRule_7(value) {
  if (typeof value !== 'string') return result(true, 'inclusive', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'inclusive', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_7(value) {
  return result(true, 'inclusive', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_7(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'inclusive', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'inclusive', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'inclusive', 'MAX', 'above maximum', n);
  return result(true, 'inclusive', 'OK', 'within range', n);
}

function listRule_7(value) {
  const list = asArray(value);
  return result(true, 'inclusive', 'LIST', 'list normalized', list);
}

function objectRule_7(value) {
  const object = asObject(value);
  return result(true, 'inclusive', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'country': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'state': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'postalCode': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'rate': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'taxClass': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'inclusive': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'active': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
