'use strict';
// Policy engine for reviews.
const DOMAIN = 'reviews';
const FIELDS = ['id', 'productId', 'buyerId', 'orderId', 'rating', 'title', 'body', 'images', 'verifiedPurchase', 'status', 'sellerReply', 'createdAt', 'updatedAt'];
...
function requiredRule_4(value) {
  if (!isDefined(value)) return result(false, 'rating', 'REQUIRED', 'rating'+' is required', value);
  return result(true, 'rating', 'OK', 'rating'+' is present', value);
}

function trimRule_4(value) {
  if (typeof value !== 'string') return result(true, 'rating', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'rating', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_4(value) {
  return result(true, 'rating', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_4(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'rating', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'rating', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'rating', 'MAX', 'above maximum', n);
  return result(true, 'rating', 'OK', 'within range', n);
}

function listRule_4(value) {
  const list = asArray(value);
  return result(true, 'rating', 'LIST', 'list normalized', list);
}

function objectRule_4(value) {
  const object = asObject(value);
  return result(true, 'rating', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'body', 'REQUIRED', 'body'+' is required', value);
  return result(true, 'body', 'OK', 'body'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'body', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'body', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'body', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'body', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'body', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'body', 'MAX', 'above maximum', n);
  return result(true, 'body', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'body', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'body', 'OBJECT', 'object normalized', object);
}

function requiredRule_7(value) {
  if (!isDefined(value)) return result(false, 'images', 'REQUIRED', 'images'+' is required', value);
  return result(true, 'images', 'OK', 'images'+' is present', value);
}

function trimRule_7(value) {
  if (typeof value !== 'string') return result(true, 'images', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'images', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_7(value) {
  return result(true, 'images', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_7(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'images', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'images', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'images', 'MAX', 'above maximum', n);
  return result(true, 'images', 'OK', 'within range', n);
}

function listRule_7(value) {
  const list = asArray(value);
  return result(true, 'images', 'LIST', 'list normalized', list);
}

function objectRule_7(value) {
  const object = asObject(value);
  return result(true, 'images', 'OBJECT', 'object normalized', object);
}

function requiredRule_8(value) {
  if (!isDefined(value)) return result(false, 'verifiedPurchase', 'REQUIRED', 'verifiedPurchase'+' is required', value);
  return result(true, 'verifiedPurchase', 'OK', 'verifiedPurchase'+' is present', value);
}

function trimRule_8(value) {
  if (typeof value !== 'string') return result(true, 'verifiedPurchase', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'verifiedPurchase', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_8(value) {
  return result(true, 'verifiedPurchase', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_8(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'verifiedPurchase', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'verifiedPurchase', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'verifiedPurchase', 'MAX', 'above maximum', n);
  return result(true, 'verifiedPurchase', 'OK', 'within range', n);
}

function listRule_8(value) {
  const list = asArray(value);
  return result(true, 'verifiedPurchase', 'LIST', 'list normalized', list);
}

function objectRule_8(value) {
  const object = asObject(value);
  return result(true, 'verifiedPurchase', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_10(value) {
  if (!isDefined(value)) return result(false, 'sellerReply', 'REQUIRED', 'sellerReply'+' is required', value);
  return result(true, 'sellerReply', 'OK', 'sellerReply'+' is present', value);
}

function trimRule_10(value) {
  if (typeof value !== 'string') return result(true, 'sellerReply', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'sellerReply', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_10(value) {
  return result(true, 'sellerReply', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_10(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'sellerReply', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'sellerReply', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'sellerReply', 'MAX', 'above maximum', n);
  return result(true, 'sellerReply', 'OK', 'within range', n);
}

function listRule_10(value) {
  const list = asArray(value);
  return result(true, 'sellerReply', 'LIST', 'list normalized', list);
}

function objectRule_10(value) {
  const object = asObject(value);
  return result(true, 'sellerReply', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'orderId': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'rating': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'title': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'body': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'images': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'verifiedPurchase': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
  'status': Object.freeze([requiredRule_9, trimRule_9, nullRule_9, rangeRule_9, listRule_9, objectRule_9]),
  'sellerReply': Object.freeze([requiredRule_10, trimRule_10, nullRule_10, rangeRule_10, listRule_10, objectRule_10]),
