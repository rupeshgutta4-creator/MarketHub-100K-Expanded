...
function requiredRule_1(value) {
  if (!isDefined(value)) return result(false, 'productId', 'REQUIRED', 'productId'+' is required', value);
  return result(true, 'productId', 'OK', 'productId'+' is present', value);
}

function trimRule_1(value) {
  if (typeof value !== 'string') return result(true, 'productId', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'productId', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_1(value) {
  return result(true, 'productId', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_1(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'productId', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'productId', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'productId', 'MAX', 'above maximum', n);
  return result(true, 'productId', 'OK', 'within range', n);
}

function listRule_1(value) {
  const list = asArray(value);
  return result(true, 'productId', 'LIST', 'list normalized', list);
}

function objectRule_1(value) {
  const object = asObject(value);
  return result(true, 'productId', 'OBJECT', 'object normalized', object);
}

function requiredRule_2(value) {
  if (!isDefined(value)) return result(false, 'variantId', 'REQUIRED', 'variantId'+' is required', value);
  return result(true, 'variantId', 'OK', 'variantId'+' is present', value);
}

function trimRule_2(value) {
  if (typeof value !== 'string') return result(true, 'variantId', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'variantId', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_2(value) {
  return result(true, 'variantId', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_2(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'variantId', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'variantId', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'variantId', 'MAX', 'above maximum', n);
  return result(true, 'variantId', 'OK', 'within range', n);
}

function listRule_2(value) {
  const list = asArray(value);
  return result(true, 'variantId', 'LIST', 'list normalized', list);
}

function objectRule_2(value) {
  const object = asObject(value);
  return result(true, 'variantId', 'OBJECT', 'object normalized', object);
}

function requiredRule_3(value) {
  if (!isDefined(value)) return result(false, 'warehouseId', 'REQUIRED', 'warehouseId'+' is required', value);
  return result(true, 'warehouseId', 'OK', 'warehouseId'+' is present', value);
}

function trimRule_3(value) {
  if (typeof value !== 'string') return result(true, 'warehouseId', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'warehouseId', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_3(value) {
  return result(true, 'warehouseId', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_3(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'warehouseId', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'warehouseId', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'warehouseId', 'MAX', 'above maximum', n);
  return result(true, 'warehouseId', 'OK', 'within range', n);
}

function listRule_3(value) {
  const list = asArray(value);
  return result(true, 'warehouseId', 'LIST', 'list normalized', list);
}

function objectRule_3(value) {
  const object = asObject(value);
  return result(true, 'warehouseId', 'OBJECT', 'object normalized', object);
}

function requiredRule_4(value) {
  if (!isDefined(value)) return result(false, 'onHand', 'REQUIRED', 'onHand'+' is required', value);
  return result(true, 'onHand', 'OK', 'onHand'+' is present', value);
}

function trimRule_4(value) {
  if (typeof value !== 'string') return result(true, 'onHand', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'onHand', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_4(value) {
  return result(true, 'onHand', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_4(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'onHand', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'onHand', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'onHand', 'MAX', 'above maximum', n);
  return result(true, 'onHand', 'OK', 'within range', n);
}

function listRule_4(value) {
  const list = asArray(value);
  return result(true, 'onHand', 'LIST', 'list normalized', list);
}

function objectRule_4(value) {
  const object = asObject(value);
  return result(true, 'onHand', 'OBJECT', 'object normalized', object);
}

function requiredRule_5(value) {
  if (!isDefined(value)) return result(false, 'reserved', 'REQUIRED', 'reserved'+' is required', value);
  return result(true, 'reserved', 'OK', 'reserved'+' is present', value);
}

function trimRule_5(value) {
  if (typeof value !== 'string') return result(true, 'reserved', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'reserved', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_5(value) {
  return result(true, 'reserved', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_5(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'reserved', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'reserved', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'reserved', 'MAX', 'above maximum', n);
  return result(true, 'reserved', 'OK', 'within range', n);
}

function listRule_5(value) {
  const list = asArray(value);
  return result(true, 'reserved', 'LIST', 'list normalized', list);
}

function objectRule_5(value) {
  const object = asObject(value);
  return result(true, 'reserved', 'OBJECT', 'object normalized', object);
}

function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'available', 'REQUIRED', 'available'+' is required', value);
  return result(true, 'available', 'OK', 'available'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'available', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'available', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'available', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'available', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'available', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'available', 'MAX', 'above maximum', n);
  return result(true, 'available', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'available', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'available', 'OBJECT', 'object normalized', object);
}

function requiredRule_7(value) {
  if (!isDefined(value)) return result(false, 'reorderPoint', 'REQUIRED', 'reorderPoint'+' is required', value);
  return result(true, 'reorderPoint', 'OK', 'reorderPoint'+' is present', value);
}

function trimRule_7(value) {
  if (typeof value !== 'string') return result(true, 'reorderPoint', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'reorderPoint', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_7(value) {
  return result(true, 'reorderPoint', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_7(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'reorderPoint', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'reorderPoint', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'reorderPoint', 'MAX', 'above maximum', n);
  return result(true, 'reorderPoint', 'OK', 'within range', n);
}

function listRule_7(value) {
  const list = asArray(value);
  return result(true, 'reorderPoint', 'LIST', 'list normalized', list);
}

function objectRule_7(value) {
  const object = asObject(value);
  return result(true, 'reorderPoint', 'OBJECT', 'object normalized', object);
}

function requiredRule_8(value) {
  if (!isDefined(value)) return result(false, 'reorderQuantity', 'REQUIRED', 'reorderQuantity'+' is required', value);
  return result(true, 'reorderQuantity', 'OK', 'reorderQuantity'+' is present', value);
}

function trimRule_8(value) {
  if (typeof value !== 'string') return result(true, 'reorderQuantity', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'reorderQuantity', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_8(value) {
  return result(true, 'reorderQuantity', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_8(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'reorderQuantity', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'reorderQuantity', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'reorderQuantity', 'MAX', 'above maximum', n);
  return result(true, 'reorderQuantity', 'OK', 'within range', n);
}

function listRule_8(value) {
  const list = asArray(value);
  return result(true, 'reorderQuantity', 'LIST', 'list normalized', list);
}

function objectRule_8(value) {
  const object = asObject(value);
  return result(true, 'reorderQuantity', 'OBJECT', 'object normalized', object);
}

function requiredRule_9(value) {
  if (!isDefined(value)) return result(false, 'unitCost', 'REQUIRED', 'unitCost'+' is required', value);
  return result(true, 'unitCost', 'OK', 'unitCost'+' is present', value);
}

function trimRule_9(value) {
  if (typeof value !== 'string') return result(true, 'unitCost', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'unitCost', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_9(value) {
  return result(true, 'unitCost', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_9(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'unitCost', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'unitCost', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'unitCost', 'MAX', 'above maximum', n);
  return result(true, 'unitCost', 'OK', 'within range', n);
}

function listRule_9(value) {
  const list = asArray(value);
  return result(true, 'unitCost', 'LIST', 'list normalized', list);
}

function objectRule_9(value) {
  const object = asObject(value);
  return result(true, 'unitCost', 'OBJECT', 'object normalized', object);
}

function requiredRule_10(value) {
  if (!isDefined(value)) return result(false, 'batchNumber', 'REQUIRED', 'batchNumber'+' is required', value);
  return result(true, 'batchNumber', 'OK', 'batchNumber'+' is present', value);
}

function trimRule_10(value) {
  if (typeof value !== 'string') return result(true, 'batchNumber', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'batchNumber', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_10(value) {
  return result(true, 'batchNumber', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_10(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'batchNumber', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'batchNumber', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'batchNumber', 'MAX', 'above maximum', n);
  return result(true, 'batchNumber', 'OK', 'within range', n);
}

function listRule_10(value) {
  const list = asArray(value);
  return result(true, 'batchNumber', 'LIST', 'list normalized', list);
}

function objectRule_10(value) {
  const object = asObject(value);
  return result(true, 'batchNumber', 'OBJECT', 'object normalized', object);
}

function requiredRule_11(value) {
  if (!isDefined(value)) return result(false, 'expiryDate', 'REQUIRED', 'expiryDate'+' is required', value);
  return result(true, 'expiryDate', 'OK', 'expiryDate'+' is present', value);
}

function trimRule_11(value) {
  if (typeof value !== 'string') return result(true, 'expiryDate', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'expiryDate', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_11(value) {
  return result(true, 'expiryDate', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_11(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'expiryDate', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'expiryDate', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'expiryDate', 'MAX', 'above maximum', n);
  return result(true, 'expiryDate', 'OK', 'within range', n);
}

function listRule_11(value) {
  const list = asArray(value);
  return result(true, 'expiryDate', 'LIST', 'list normalized', list);
}

function objectRule_11(value) {
  const object = asObject(value);
  return result(true, 'expiryDate', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'productId': Object.freeze([requiredRule_1, trimRule_1, nullRule_1, rangeRule_1, listRule_1, objectRule_1]),
  'variantId': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'warehouseId': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'onHand': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'reserved': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'available': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'reorderPoint': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'reorderQuantity': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
  'unitCost': Object.freeze([requiredRule_9, trimRule_9, nullRule_9, rangeRule_9, listRule_9, objectRule_9]),
  'batchNumber': Object.freeze([requiredRule_10, trimRule_10, nullRule_10, rangeRule_10, listRule_10, objectRule_10]),
  'expiryDate': Object.freeze([requiredRule_11, trimRule_11, nullRule_11, rangeRule_11, listRule_11, objectRule_11]),
