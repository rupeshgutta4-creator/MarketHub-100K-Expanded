'use strict';
// Policy engine for settings.
const DOMAIN = 'settings';
const FIELDS = ['id', 'key', 'value', 'type', 'scope', 'description', 'isSecret', 'createdAt', 'updatedAt'];
...
function requiredRule_1(value) {
  if (!isDefined(value)) return result(false, 'key', 'REQUIRED', 'key'+' is required', value);
  return result(true, 'key', 'OK', 'key'+' is present', value);
}

function trimRule_1(value) {
  if (typeof value !== 'string') return result(true, 'key', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'key', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_1(value) {
  return result(true, 'key', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_1(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'key', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'key', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'key', 'MAX', 'above maximum', n);
  return result(true, 'key', 'OK', 'within range', n);
}

function listRule_1(value) {
  const list = asArray(value);
  return result(true, 'key', 'LIST', 'list normalized', list);
}

function objectRule_1(value) {
  const object = asObject(value);
  return result(true, 'key', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_4(value) {
  if (!isDefined(value)) return result(false, 'scope', 'REQUIRED', 'scope'+' is required', value);
  return result(true, 'scope', 'OK', 'scope'+' is present', value);
}

function trimRule_4(value) {
  if (typeof value !== 'string') return result(true, 'scope', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'scope', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_4(value) {
  return result(true, 'scope', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_4(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'scope', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'scope', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'scope', 'MAX', 'above maximum', n);
  return result(true, 'scope', 'OK', 'within range', n);
}

function listRule_4(value) {
  const list = asArray(value);
  return result(true, 'scope', 'LIST', 'list normalized', list);
}

function objectRule_4(value) {
  const object = asObject(value);
  return result(true, 'scope', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'isSecret', 'REQUIRED', 'isSecret'+' is required', value);
  return result(true, 'isSecret', 'OK', 'isSecret'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'isSecret', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'isSecret', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'isSecret', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'isSecret', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'isSecret', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'isSecret', 'MAX', 'above maximum', n);
  return result(true, 'isSecret', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'isSecret', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'isSecret', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'key': Object.freeze([requiredRule_1, trimRule_1, nullRule_1, rangeRule_1, listRule_1, objectRule_1]),
  'value': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'type': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'scope': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'description': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'isSecret': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
