'use strict';
// Policy engine for cartItems.
const DOMAIN = 'cartItems';
const FIELDS = ['id', 'cartId', 'productId', 'variantId', 'quantity', 'unitPrice', 'lineTotal', 'createdAt', 'updatedAt'];
...
function requiredRule_1(value) {
  if (!isDefined(value)) return result(false, 'cartId', 'REQUIRED', 'cartId'+' is required', value);
  return result(true, 'cartId', 'OK', 'cartId'+' is present', value);
}

function trimRule_1(value) {
  if (typeof value !== 'string') return result(true, 'cartId', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'cartId', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_1(value) {
  return result(true, 'cartId', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_1(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'cartId', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'cartId', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'cartId', 'MAX', 'above maximum', n);
  return result(true, 'cartId', 'OK', 'within range', n);
}

function listRule_1(value) {
  const list = asArray(value);
  return result(true, 'cartId', 'LIST', 'list normalized', list);
}

function objectRule_1(value) {
  const object = asObject(value);
  return result(true, 'cartId', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_5(value) {
  if (!isDefined(value)) return result(false, 'unitPrice', 'REQUIRED', 'unitPrice'+' is required', value);
  return result(true, 'unitPrice', 'OK', 'unitPrice'+' is present', value);
}

function trimRule_5(value) {
  if (typeof value !== 'string') return result(true, 'unitPrice', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'unitPrice', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_5(value) {
  return result(true, 'unitPrice', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_5(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'unitPrice', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'unitPrice', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'unitPrice', 'MAX', 'above maximum', n);
  return result(true, 'unitPrice', 'OK', 'within range', n);
}

function listRule_5(value) {
  const list = asArray(value);
  return result(true, 'unitPrice', 'LIST', 'list normalized', list);
}

function objectRule_5(value) {
  const object = asObject(value);
  return result(true, 'unitPrice', 'OBJECT', 'object normalized', object);
}

function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'lineTotal', 'REQUIRED', 'lineTotal'+' is required', value);
  return result(true, 'lineTotal', 'OK', 'lineTotal'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'lineTotal', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'lineTotal', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'lineTotal', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'lineTotal', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'lineTotal', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'lineTotal', 'MAX', 'above maximum', n);
  return result(true, 'lineTotal', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'lineTotal', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'lineTotal', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'cartId': Object.freeze([requiredRule_1, trimRule_1, nullRule_1, rangeRule_1, listRule_1, objectRule_1]),
  'productId': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'variantId': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'quantity': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'unitPrice': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'lineTotal': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'createdAt': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'updatedAt': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
});
