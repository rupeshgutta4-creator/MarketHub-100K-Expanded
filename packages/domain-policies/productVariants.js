'use strict';
// Policy engine for productVariants.
...
function requiredRule_4(value) {
  if (!isDefined(value)) return result(false, 'optionValues', 'REQUIRED', 'optionValues'+' is required', value);
  return result(true, 'optionValues', 'OK', 'optionValues'+' is present', value);
}

function trimRule_4(value) {
  if (typeof value !== 'string') return result(true, 'optionValues', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'optionValues', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_4(value) {
  return result(true, 'optionValues', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_4(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'optionValues', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'optionValues', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'optionValues', 'MAX', 'above maximum', n);
  return result(true, 'optionValues', 'OK', 'within range', n);
}

function listRule_4(value) {
  const list = asArray(value);
  return result(true, 'optionValues', 'LIST', 'list normalized', list);
}

function objectRule_4(value) {
  const object = asObject(value);
  return result(true, 'optionValues', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_10(value) {
  if (!isDefined(value)) return result(false, 'barcode', 'REQUIRED', 'barcode'+' is required', value);
  return result(true, 'barcode', 'OK', 'barcode'+' is present', value);
}

function trimRule_10(value) {
  if (typeof value !== 'string') return result(true, 'barcode', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'barcode', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_10(value) {
  return result(true, 'barcode', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_10(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'barcode', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'barcode', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'barcode', 'MAX', 'above maximum', n);
  return result(true, 'barcode', 'OK', 'within range', n);
}

function listRule_10(value) {
  const list = asArray(value);
  return result(true, 'barcode', 'LIST', 'list normalized', list);
}

function objectRule_10(value) {
  const object = asObject(value);
  return result(true, 'barcode', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'sku': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'name': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'optionValues': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'price': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'compareAt': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'costPrice': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'stock': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
  'weight': Object.freeze([requiredRule_9, trimRule_9, nullRule_9, rangeRule_9, listRule_9, objectRule_9]),
  'barcode': Object.freeze([requiredRule_10, trimRule_10, nullRule_10, rangeRule_10, listRule_10, objectRule_10]),
  'imageUrl': Object.freeze([requiredRule_11, trimRule_11, nullRule_11, rangeRule_11, listRule_11, objectRule_11]),
