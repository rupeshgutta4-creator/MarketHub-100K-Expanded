'use strict';
// Policy engine for adEvents.
const DOMAIN = 'adEvents';
const FIELDS = ['id', 'campaignId', 'productId', 'userId', 'type', 'cost', 'metadata', 'createdAt'];
...
function requiredRule_1(value) {
  if (!isDefined(value)) return result(false, 'campaignId', 'REQUIRED', 'campaignId'+' is required', value);
  return result(true, 'campaignId', 'OK', 'campaignId'+' is present', value);
}

function trimRule_1(value) {
  if (typeof value !== 'string') return result(true, 'campaignId', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'campaignId', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_1(value) {
  return result(true, 'campaignId', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_1(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'campaignId', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'campaignId', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'campaignId', 'MAX', 'above maximum', n);
  return result(true, 'campaignId', 'OK', 'within range', n);
}

function listRule_1(value) {
  const list = asArray(value);
  return result(true, 'campaignId', 'LIST', 'list normalized', list);
}

function objectRule_1(value) {
  const object = asObject(value);
  return result(true, 'campaignId', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_5(value) {
  if (!isDefined(value)) return result(false, 'cost', 'REQUIRED', 'cost'+' is required', value);
  return result(true, 'cost', 'OK', 'cost'+' is present', value);
}

function trimRule_5(value) {
  if (typeof value !== 'string') return result(true, 'cost', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'cost', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_5(value) {
  return result(true, 'cost', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_5(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'cost', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'cost', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'cost', 'MAX', 'above maximum', n);
  return result(true, 'cost', 'OK', 'within range', n);
}

function listRule_5(value) {
  const list = asArray(value);
  return result(true, 'cost', 'LIST', 'list normalized', list);
}

function objectRule_5(value) {
  const object = asObject(value);
  return result(true, 'cost', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'campaignId': Object.freeze([requiredRule_1, trimRule_1, nullRule_1, rangeRule_1, listRule_1, objectRule_1]),
  'productId': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'userId': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'type': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'cost': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'metadata': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
