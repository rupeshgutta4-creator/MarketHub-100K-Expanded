'use strict';
// Policy engine for priceRules.
const DOMAIN = 'priceRules';
const FIELDS = ['id', 'name', 'productId', 'categoryId', 'minQuantity', 'price', 'percentageOff', 'startsAt', 'endsAt', 'active', 'createdAt', 'updatedAt'];
...
function requiredRule_4(value) {
  if (!isDefined(value)) return result(false, 'minQuantity', 'REQUIRED', 'minQuantity'+' is required', value);
  return result(true, 'minQuantity', 'OK', 'minQuantity'+' is present', value);
}

function trimRule_4(value) {
  if (typeof value !== 'string') return result(true, 'minQuantity', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'minQuantity', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_4(value) {
  return result(true, 'minQuantity', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_4(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'minQuantity', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'minQuantity', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'minQuantity', 'MAX', 'above maximum', n);
  return result(true, 'minQuantity', 'OK', 'within range', n);
}

function listRule_4(value) {
  const list = asArray(value);
  return result(true, 'minQuantity', 'LIST', 'list normalized', list);
}

function objectRule_4(value) {
  const object = asObject(value);
  return result(true, 'minQuantity', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'percentageOff', 'REQUIRED', 'percentageOff'+' is required', value);
  return result(true, 'percentageOff', 'OK', 'percentageOff'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'percentageOff', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'percentageOff', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'percentageOff', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'percentageOff', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'percentageOff', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'percentageOff', 'MAX', 'above maximum', n);
  return result(true, 'percentageOff', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'percentageOff', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'percentageOff', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'categoryId': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'minQuantity': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'price': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'percentageOff': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'startsAt': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'endsAt': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
  'active': Object.freeze([requiredRule_9, trimRule_9, nullRule_9, rangeRule_9, listRule_9, objectRule_9]),
