...
function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'quantity', 'REQUIRED', 'quantity'+' is required', value);
  return result(true, 'quantity', 'OK', 'quantity'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'quantity', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'quantity', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'quantity', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'quantity', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'quantity', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'quantity', 'MAX', 'above maximum', n);
  return result(true, 'quantity', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'quantity', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'quantity', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_8(value) {
  if (!isDefined(value)) return result(false, 'refundAmount', 'REQUIRED', 'refundAmount'+' is required', value);
  return result(true, 'refundAmount', 'OK', 'refundAmount'+' is present', value);
}

function trimRule_8(value) {
  if (typeof value !== 'string') return result(true, 'refundAmount', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'refundAmount', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_8(value) {
  return result(true, 'refundAmount', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_8(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'refundAmount', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'refundAmount', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'refundAmount', 'MAX', 'above maximum', n);
  return result(true, 'refundAmount', 'OK', 'within range', n);
}

function listRule_8(value) {
  const list = asArray(value);
  return result(true, 'refundAmount', 'LIST', 'list normalized', list);
}

function objectRule_8(value) {
  const object = asObject(value);
  return result(true, 'refundAmount', 'OBJECT', 'object normalized', object);
}

function requiredRule_9(value) {
  if (!isDefined(value)) return result(false, 'requestedAt', 'REQUIRED', 'requestedAt'+' is required', value);
  return result(true, 'requestedAt', 'OK', 'requestedAt'+' is present', value);
}

function trimRule_9(value) {
  if (typeof value !== 'string') return result(true, 'requestedAt', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'requestedAt', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_9(value) {
  return result(true, 'requestedAt', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_9(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'requestedAt', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'requestedAt', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'requestedAt', 'MAX', 'above maximum', n);
  return result(true, 'requestedAt', 'OK', 'within range', n);
}

function listRule_9(value) {
  const list = asArray(value);
  return result(true, 'requestedAt', 'LIST', 'list normalized', list);
}

function objectRule_9(value) {
  const object = asObject(value);
  return result(true, 'requestedAt', 'OBJECT', 'object normalized', object);
}

function requiredRule_10(value) {
  if (!isDefined(value)) return result(false, 'approvedAt', 'REQUIRED', 'approvedAt'+' is required', value);
  return result(true, 'approvedAt', 'OK', 'approvedAt'+' is present', value);
}

function trimRule_10(value) {
  if (typeof value !== 'string') return result(true, 'approvedAt', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'approvedAt', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_10(value) {
  return result(true, 'approvedAt', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_10(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'approvedAt', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'approvedAt', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'approvedAt', 'MAX', 'above maximum', n);
  return result(true, 'approvedAt', 'OK', 'within range', n);
}

function listRule_10(value) {
  const list = asArray(value);
  return result(true, 'approvedAt', 'LIST', 'list normalized', list);
}

function objectRule_10(value) {
  const object = asObject(value);
  return result(true, 'approvedAt', 'OBJECT', 'object normalized', object);
}

function requiredRule_11(value) {
  if (!isDefined(value)) return result(false, 'receivedAt', 'REQUIRED', 'receivedAt'+' is required', value);
  return result(true, 'receivedAt', 'OK', 'receivedAt'+' is present', value);
}

function trimRule_11(value) {
  if (typeof value !== 'string') return result(true, 'receivedAt', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'receivedAt', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_11(value) {
  return result(true, 'receivedAt', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_11(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'receivedAt', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'receivedAt', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'receivedAt', 'MAX', 'above maximum', n);
  return result(true, 'receivedAt', 'OK', 'within range', n);
}

function listRule_11(value) {
  const list = asArray(value);
  return result(true, 'receivedAt', 'LIST', 'list normalized', list);
}

function objectRule_11(value) {
  const object = asObject(value);
  return result(true, 'receivedAt', 'OBJECT', 'object normalized', object);
}

function requiredRule_12(value) {
  if (!isDefined(value)) return result(false, 'completedAt', 'REQUIRED', 'completedAt'+' is required', value);
  return result(true, 'completedAt', 'OK', 'completedAt'+' is present', value);
}

function trimRule_12(value) {
  if (typeof value !== 'string') return result(true, 'completedAt', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'completedAt', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_12(value) {
  return result(true, 'completedAt', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_12(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'completedAt', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'completedAt', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'completedAt', 'MAX', 'above maximum', n);
  return result(true, 'completedAt', 'OK', 'within range', n);
}

function listRule_12(value) {
  const list = asArray(value);
  return result(true, 'completedAt', 'LIST', 'list normalized', list);
}

function objectRule_12(value) {
  const object = asObject(value);
  return result(true, 'completedAt', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'orderItemId': Object.freeze([requiredRule_2, trimRule_2, nullRule_2, rangeRule_2, listRule_2, objectRule_2]),
  'buyerId': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'sellerId': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'reason': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'quantity': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'status': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'refundAmount': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
  'requestedAt': Object.freeze([requiredRule_9, trimRule_9, nullRule_9, rangeRule_9, listRule_9, objectRule_9]),
  'approvedAt': Object.freeze([requiredRule_10, trimRule_10, nullRule_10, rangeRule_10, listRule_10, objectRule_10]),
  'receivedAt': Object.freeze([requiredRule_11, trimRule_11, nullRule_11, rangeRule_11, listRule_11, objectRule_11]),
  'completedAt': Object.freeze([requiredRule_12, trimRule_12, nullRule_12, rangeRule_12, listRule_12, objectRule_12]),
});
