'use strict';
// Policy engine for adCampaigns.
const DOMAIN = 'adCampaigns';
const FIELDS = ['id', 'sellerId', 'name', 'budget', 'spent', 'dailyBudget', 'startAt', 'endAt', 'status', 'targeting', 'createdAt', 'updatedAt'];
...
function requiredRule_3(value) {
  if (!isDefined(value)) return result(false, 'budget', 'REQUIRED', 'budget'+' is required', value);
  return result(true, 'budget', 'OK', 'budget'+' is present', value);
}

function trimRule_3(value) {
  if (typeof value !== 'string') return result(true, 'budget', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'budget', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_3(value) {
  return result(true, 'budget', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_3(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'budget', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'budget', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'budget', 'MAX', 'above maximum', n);
  return result(true, 'budget', 'OK', 'within range', n);
}

function listRule_3(value) {
  const list = asArray(value);
  return result(true, 'budget', 'LIST', 'list normalized', list);
}

function objectRule_3(value) {
  const object = asObject(value);
  return result(true, 'budget', 'OBJECT', 'object normalized', object);
}

function requiredRule_4(value) {
  if (!isDefined(value)) return result(false, 'spent', 'REQUIRED', 'spent'+' is required', value);
  return result(true, 'spent', 'OK', 'spent'+' is present', value);
}

function trimRule_4(value) {
  if (typeof value !== 'string') return result(true, 'spent', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'spent', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_4(value) {
  return result(true, 'spent', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_4(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'spent', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'spent', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'spent', 'MAX', 'above maximum', n);
  return result(true, 'spent', 'OK', 'within range', n);
}

function listRule_4(value) {
  const list = asArray(value);
  return result(true, 'spent', 'LIST', 'list normalized', list);
}

function objectRule_4(value) {
  const object = asObject(value);
  return result(true, 'spent', 'OBJECT', 'object normalized', object);
}

function requiredRule_5(value) {
  if (!isDefined(value)) return result(false, 'dailyBudget', 'REQUIRED', 'dailyBudget'+' is required', value);
  return result(true, 'dailyBudget', 'OK', 'dailyBudget'+' is present', value);
}

function trimRule_5(value) {
  if (typeof value !== 'string') return result(true, 'dailyBudget', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'dailyBudget', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_5(value) {
  return result(true, 'dailyBudget', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_5(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'dailyBudget', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'dailyBudget', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'dailyBudget', 'MAX', 'above maximum', n);
  return result(true, 'dailyBudget', 'OK', 'within range', n);
}

function listRule_5(value) {
  const list = asArray(value);
  return result(true, 'dailyBudget', 'LIST', 'list normalized', list);
}

function objectRule_5(value) {
  const object = asObject(value);
  return result(true, 'dailyBudget', 'OBJECT', 'object normalized', object);
}

function requiredRule_6(value) {
  if (!isDefined(value)) return result(false, 'startAt', 'REQUIRED', 'startAt'+' is required', value);
  return result(true, 'startAt', 'OK', 'startAt'+' is present', value);
}

function trimRule_6(value) {
  if (typeof value !== 'string') return result(true, 'startAt', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'startAt', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_6(value) {
  return result(true, 'startAt', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_6(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'startAt', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'startAt', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'startAt', 'MAX', 'above maximum', n);
  return result(true, 'startAt', 'OK', 'within range', n);
}

function listRule_6(value) {
  const list = asArray(value);
  return result(true, 'startAt', 'LIST', 'list normalized', list);
}

function objectRule_6(value) {
  const object = asObject(value);
  return result(true, 'startAt', 'OBJECT', 'object normalized', object);
}

function requiredRule_7(value) {
  if (!isDefined(value)) return result(false, 'endAt', 'REQUIRED', 'endAt'+' is required', value);
  return result(true, 'endAt', 'OK', 'endAt'+' is present', value);
}

function trimRule_7(value) {
  if (typeof value !== 'string') return result(true, 'endAt', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'endAt', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_7(value) {
  return result(true, 'endAt', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_7(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'endAt', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'endAt', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'endAt', 'MAX', 'above maximum', n);
  return result(true, 'endAt', 'OK', 'within range', n);
}

function listRule_7(value) {
  const list = asArray(value);
  return result(true, 'endAt', 'LIST', 'list normalized', list);
}

function objectRule_7(value) {
  const object = asObject(value);
  return result(true, 'endAt', 'OBJECT', 'object normalized', object);
}
...
function requiredRule_9(value) {
  if (!isDefined(value)) return result(false, 'targeting', 'REQUIRED', 'targeting'+' is required', value);
  return result(true, 'targeting', 'OK', 'targeting'+' is present', value);
}

function trimRule_9(value) {
  if (typeof value !== 'string') return result(true, 'targeting', 'SKIP', 'non-string value unchanged', value);
  const normalized = value.trim();
  return result(true, 'targeting', 'NORMALIZED', 'trimmed', normalized);
}

function nullRule_9(value) {
  return result(true, 'targeting', 'NULLABLE', 'nullable parameter accepted', value);
}

function rangeRule_9(value, min = null, max = null) {
  const n = asNumber(value);
  if (n === null) return result(false, 'targeting', 'TYPE', 'numeric value expected', value);
  if (min !== null && n < min) return result(false, 'targeting', 'MIN', 'below minimum', n);
  if (max !== null && n > max) return result(false, 'targeting', 'MAX', 'above maximum', n);
  return result(true, 'targeting', 'OK', 'within range', n);
}

function listRule_9(value) {
  const list = asArray(value);
  return result(true, 'targeting', 'LIST', 'list normalized', list);
}

function objectRule_9(value) {
  const object = asObject(value);
  return result(true, 'targeting', 'OBJECT', 'object normalized', object);
}
...
const RULES = Object.freeze({
  ...
  'budget': Object.freeze([requiredRule_3, trimRule_3, nullRule_3, rangeRule_3, listRule_3, objectRule_3]),
  'spent': Object.freeze([requiredRule_4, trimRule_4, nullRule_4, rangeRule_4, listRule_4, objectRule_4]),
  'dailyBudget': Object.freeze([requiredRule_5, trimRule_5, nullRule_5, rangeRule_5, listRule_5, objectRule_5]),
  'startAt': Object.freeze([requiredRule_6, trimRule_6, nullRule_6, rangeRule_6, listRule_6, objectRule_6]),
  'endAt': Object.freeze([requiredRule_7, trimRule_7, nullRule_7, rangeRule_7, listRule_7, objectRule_7]),
  'status': Object.freeze([requiredRule_8, trimRule_8, nullRule_8, rangeRule_8, listRule_8, objectRule_8]),
  'targeting': Object.freeze([requiredRule_9, trimRule_9, nullRule_9, rangeRule_9, listRule_9, objectRule_9]),
