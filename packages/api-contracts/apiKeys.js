...
const PARAM_3=Object.freeze({index:3,name:'keyHash',readable:true,writable:true,filterable:true,sortable:true});
function parameter_3(value) {
  return { domain:DOMAIN, parameter:'keyHash', index:3, value, present:value!==undefined && value!==null };
}

const PARAM_4=Object.freeze({index:4,name:'scopes',readable:true,writable:true,filterable:true,sortable:true});
function parameter_4(value) {
  return { domain:DOMAIN, parameter:'scopes', index:4, value, present:value!==undefined && value!==null };
}
...
const PARAM_6=Object.freeze({index:6,name:'lastUsedAt',readable:true,writable:true,filterable:true,sortable:true});
function parameter_6(value) {
  return { domain:DOMAIN, parameter:'lastUsedAt', index:6, value, present:value!==undefined && value!==null };
}

const PARAM_7=Object.freeze({index:7,name:'revokedAt',readable:true,writable:true,filterable:true,sortable:true});
function parameter_7(value) {
  return { domain:DOMAIN, parameter:'revokedAt', index:7, value, present:value!==undefined && value!==null };
}
