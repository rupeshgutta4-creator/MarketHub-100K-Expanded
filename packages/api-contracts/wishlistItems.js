...
const PARAM_1=Object.freeze({index:1,name:'wishlistId',readable:true,writable:true,filterable:true,sortable:true});
function parameter_1(value) {
  return { domain:DOMAIN, parameter:'wishlistId', index:1, value, present:value!==undefined && value!==null };
}
