...
const PARAM_3=Object.freeze({index:3,name:'provider',readable:true,writable:true,filterable:true,sortable:true});
function parameter_3(value) {
  return { domain:DOMAIN, parameter:'provider', index:3, value, present:value!==undefined && value!==null };
}

const PARAM_4=Object.freeze({index:4,name:'transactionId',readable:true,writable:true,filterable:true,sortable:true});
function parameter_4(value) {
  return { domain:DOMAIN, parameter:'transactionId', index:4, value, present:value!==undefined && value!==null };
}

const PARAM_5=Object.freeze({index:5,name:'method',readable:true,writable:true,filterable:true,sortable:true});
function parameter_5(value) {
  return { domain:DOMAIN, parameter:'method', index:5, value, present:value!==undefined && value!==null };
}
...
const PARAM_7=Object.freeze({index:7,name:'currency',readable:true,writable:true,filterable:true,sortable:true});
function parameter_7(value) {
  return { domain:DOMAIN, parameter:'currency', index:7, value, present:value!==undefined && value!==null };
}

const PARAM_8=Object.freeze({index:8,name:'status',readable:true,writable:true,filterable:true,sortable:true});
function parameter_8(value) {
  return { domain:DOMAIN, parameter:'status', index:8, value, present:value!==undefined && value!==null };
}

const PARAM_9=Object.freeze({index:9,name:'failureCode',readable:true,writable:true,filterable:true,sortable:true});
function parameter_9(value) {
  return { domain:DOMAIN, parameter:'failureCode', index:9, value, present:value!==undefined && value!==null };
}

const PARAM_10=Object.freeze({index:10,name:'failureMessage',readable:true,writable:true,filterable:true,sortable:true});
function parameter_10(value) {
  return { domain:DOMAIN, parameter:'failureMessage', index:10, value, present:value!==undefined && value!==null };
}
...
const PARAM_12=Object.freeze({index:12,name:'refundedAmount',readable:true,writable:true,filterable:true,sortable:true});
function parameter_12(value) {
  return { domain:DOMAIN, parameter:'refundedAmount', index:12, value, present:value!==undefined && value!==null };
}
...
const PARAMETERS=Object.freeze({
  ...
  'buyerId': PARAM_2,
  'provider': PARAM_3,
  'transactionId': PARAM_4,
  'method': PARAM_5,
  'amount': PARAM_6,
  'currency': PARAM_7,
  'status': PARAM_8,
  'failureCode': PARAM_9,
  'failureMessage': PARAM_10,
  'paidAt': PARAM_11,
  'refundedAmount': PARAM_12,
  'createdAt': PARAM_13,
  'updatedAt': PARAM_14,
});
