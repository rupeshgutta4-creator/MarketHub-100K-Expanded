...
const PARAM_2=Object.freeze({index:2,name:'initialBalance',readable:true,writable:true,filterable:true,sortable:true});
function parameter_2(value) {
  return { domain:DOMAIN, parameter:'initialBalance', index:2, value, present:value!==undefined && value!==null };
}

const PARAM_3=Object.freeze({index:3,name:'remainingBalance',readable:true,writable:true,filterable:true,sortable:true});
function parameter_3(value) {
  return { domain:DOMAIN, parameter:'remainingBalance', index:3, value, present:value!==undefined && value!==null };
}

const PARAM_4=Object.freeze({index:4,name:'currency',readable:true,writable:true,filterable:true,sortable:true});
function parameter_4(value) {
  return { domain:DOMAIN, parameter:'currency', index:4, value, present:value!==undefined && value!==null };
}

const PARAM_5=Object.freeze({index:5,name:'buyerId',readable:true,writable:true,filterable:true,sortable:true});
function parameter_5(value) {
  return { domain:DOMAIN, parameter:'buyerId', index:5, value, present:value!==undefined && value!==null };
}

const PARAM_6=Object.freeze({index:6,name:'recipientEmail',readable:true,writable:true,filterable:true,sortable:true});
function parameter_6(value) {
  return { domain:DOMAIN, parameter:'recipientEmail', index:6, value, present:value!==undefined && value!==null };
}

const PARAM_7=Object.freeze({index:7,name:'expiresAt',readable:true,writable:true,filterable:true,sortable:true});
function parameter_7(value) {
  return { domain:DOMAIN, parameter:'expiresAt', index:7, value, present:value!==undefined && value!==null };
}
...
const PARAMETERS=Object.freeze({
  'id': PARAM_0,
  'code': PARAM_1,
  'initialBalance': PARAM_2,
  'remainingBalance': PARAM_3,
  'currency': PARAM_4,
  'buyerId': PARAM_5,
  'recipientEmail': PARAM_6,
  'expiresAt': PARAM_7,
  'status': PARAM_8,
  'createdAt': PARAM_9,
  'updatedAt': PARAM_10,
