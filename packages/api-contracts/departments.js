...
const PARAM_3=Object.freeze({index:3,name:'managerId',readable:true,writable:true,filterable:true,sortable:true});
function parameter_3(value) {
  return { domain:DOMAIN, parameter:'managerId', index:3, value, present:value!==undefined && value!==null };
}
