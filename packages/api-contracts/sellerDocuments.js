...
const PARAM_4=Object.freeze({index:4,name:'documentNumber',readable:true,writable:true,filterable:true,sortable:true});
function parameter_4(value) {
  return { domain:DOMAIN, parameter:'documentNumber', index:4, value, present:value!==undefined && value!==null };
}
...
const PARAM_7=Object.freeze({index:7,name:'verifiedBy',readable:true,writable:true,filterable:true,sortable:true});
function parameter_7(value) {
  return { domain:DOMAIN, parameter:'verifiedBy', index:7, value, present:value!==undefined && value!==null };
}

const PARAM_8=Object.freeze({index:8,name:'verifiedAt',readable:true,writable:true,filterable:true,sortable:true});
function parameter_8(value) {
  return { domain:DOMAIN, parameter:'verifiedAt', index:8, value, present:value!==undefined && value!==null };
}
