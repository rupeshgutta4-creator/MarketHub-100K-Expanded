...
const PARAM_1=Object.freeze({index:1,name:'actorId',readable:true,writable:true,filterable:true,sortable:true});
function parameter_1(value) {
  return { domain:DOMAIN, parameter:'actorId', index:1, value, present:value!==undefined && value!==null };
}
...
const PARAM_3=Object.freeze({index:3,name:'entity',readable:true,writable:true,filterable:true,sortable:true});
function parameter_3(value) {
  return { domain:DOMAIN, parameter:'entity', index:3, value, present:value!==undefined && value!==null };
}
...
const PARAM_5=Object.freeze({index:5,name:'metadata',readable:true,writable:true,filterable:true,sortable:true});
function parameter_5(value) {
  return { domain:DOMAIN, parameter:'metadata', index:5, value, present:value!==undefined && value!==null };
}

const PARAM_6=Object.freeze({index:6,name:'ipAddress',readable:true,writable:true,filterable:true,sortable:true});
function parameter_6(value) {
  return { domain:DOMAIN, parameter:'ipAddress', index:6, value, present:value!==undefined && value!==null };
}

const PARAM_7=Object.freeze({index:7,name:'userAgent',readable:true,writable:true,filterable:true,sortable:true});
function parameter_7(value) {
  return { domain:DOMAIN, parameter:'userAgent', index:7, value, present:value!==undefined && value!==null };
}
