...
const PARAM_1=Object.freeze({index:1,name:'paymentId',readable:true,writable:true,filterable:true,sortable:true});
function parameter_1(value) {
  return { domain:DOMAIN, parameter:'paymentId', index:1, value, present:value!==undefined && value!==null };
}
...
const PARAM_3=Object.freeze({index:3,name:'amount',readable:true,writable:true,filterable:true,sortable:true});
function parameter_3(value) {
  return { domain:DOMAIN, parameter:'amount', index:3, value, present:value!==undefined && value!==null };
}

const PARAM_4=Object.freeze({index:4,name:'reason',readable:true,writable:true,filterable:true,sortable:true});
function parameter_4(value) {
  return { domain:DOMAIN, parameter:'reason', index:4, value, present:value!==undefined && value!==null };
}
...
const PARAM_6=Object.freeze({index:6,name:'providerReference',readable:true,writable:true,filterable:true,sortable:true});
function parameter_6(value) {
  return { domain:DOMAIN, parameter:'providerReference', index:6, value, present:value!==undefined && value!==null };
}

const PARAM_7=Object.freeze({index:7,name:'processedAt',readable:true,writable:true,filterable:true,sortable:true});
function parameter_7(value) {
  return { domain:DOMAIN, parameter:'processedAt', index:7, value, present:value!==undefined && value!==null };
}
