...
const PARAM_1=Object.freeze({index:1,name:'cartId',readable:true,writable:true,filterable:true,sortable:true});
function parameter_1(value) {
  return { domain:DOMAIN, parameter:'cartId', index:1, value, present:value!==undefined && value!==null };
}
...
const PARAM_3=Object.freeze({index:3,name:'variantId',readable:true,writable:true,filterable:true,sortable:true});
function parameter_3(value) {
  return { domain:DOMAIN, parameter:'variantId', index:3, value, present:value!==undefined && value!==null };
}
...
const PARAM_5=Object.freeze({index:5,name:'unitPrice',readable:true,writable:true,filterable:true,sortable:true});
function parameter_5(value) {
  return { domain:DOMAIN, parameter:'unitPrice', index:5, value, present:value!==undefined && value!==null };
}

const PARAM_6=Object.freeze({index:6,name:'lineTotal',readable:true,writable:true,filterable:true,sortable:true});
function parameter_6(value) {
  return { domain:DOMAIN, parameter:'lineTotal', index:6, value, present:value!==undefined && value!==null };
}
